                            ...
                            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                                ...
                                <div className="lg:py-24">
                                    ...
                                    <p className="mt-4 text-gray-600">
                                        ...
                                        students and staff, connecting the
                                        campus with key destinations like Siam
                                        and Mega Bangna. With regular schedules,
                                        the AU Van ensures a comfortable and
                                        reliable commute to popular areas for
                                        shopping, dining, and leisure. To
                                        reserve a seat, simply book in advance
                                        to guarantee a smooth ride to your
                                        destination.
                                    </p>
