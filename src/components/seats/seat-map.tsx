...
export function SeatMap({
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative w-full rounded-xl border border-[#d6dcf4] bg-[#fbfcff] p-3">
        <div className="mb-2 flex items-center justify-between text-[10px]">
          <span className="rounded bg-[#e9edfd] px-2 py-0.5 font-semibold text-[#3f53c9]">
            Choose Seat
          </span>
          <span className="text-[#7d88bf]">Max {maxSeats}</span>
        </div>
        ...
        <div className="flex flex-col gap-2">
          {rows.map((row, rowIdx) => (
            <div key={rowIdx} className="flex items-center justify-center gap-2">
              ...
              <div className="h-px w-6 bg-[#d6dcf4]" />
              <div className="flex gap-1.5">
